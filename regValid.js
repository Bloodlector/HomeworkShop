class Validator {
    constructor(form) {
        this.patterns = {
            name: /^[a-zа-яё]+$/i,
            phone: /(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z!@#$%^&*]{8,}/g,
            email: /^[\w._-]+@\w+\.[a-z]{2,4}$/i
        };
        this.errors = {
            name: 'Это поле должно содержать только латинские или русские буквы',
            phone: 'Пароль должен содержать 8 символов, в том числе одну цифру, один спецсимвол и по одной букве верхнего и нижнего регистра',
